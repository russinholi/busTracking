Ext.define('BusTrackingBusApp.store.ResponsePontoStore', {
    extend : 'Ext.data.Store',

    alias : 'store.responsepontostore',
    requires : ['BusTrackingBusApp.model.ResponsePonto'],

    config : {
        model : 'BusTrackingBusApp.model.ResponsePonto',
       /* data: [
